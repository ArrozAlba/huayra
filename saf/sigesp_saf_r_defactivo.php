...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/sigesp_saf_rpp_defactivo.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato+"&codresuso="+ls_codresuso,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
