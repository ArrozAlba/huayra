<?php
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$tbHtml .= "<tr><td>".$la_data[$li_i]['codact']."</td>
					    <td>".$la_data[$li_i]['denact']."</td>
						<td>".$la_data[$li_i]['resuso']."</td>
						<td>".$la_data[$li_i]['maract']."</td>
						<td>".$la_data[$li_i]['modact']."</td>
						<td>".$la_data[$li_i]['feccmpact']."</td>
						<td>".$la_data[$li_i]['costo']."</td>
					   <td>".$la_data[$li_i]['catalogo']."</td>";
		}

		$tbHtml .= "</html>";
		header("Content-type: application/octet-stream");
		header("Content-Disposition: attachment; filename=listadodeactivos.xls");
