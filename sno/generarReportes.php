...
if ($ape!=""){
	...
	if($emp_transferencia!=""){
	    ...
	    $lobjPdf->Ln();
	        ...
	        $lobjPdf->WriteFlowingBlock(utf8_decode("Abg. Daira Jellynee Martinez Castillo,"));
	        $lobjPdf->SetFont('Arial', '', 12);
	        $lobjPdf->WriteFlowingBlock(utf8_decode(" titular de la cédula de identidad Nro V-11.399.169, en mi carácter de "));
	        $lobjPdf->SetFont('Arial', 'B', 12);
    ...
    if ($cesta){
        ...
        $lobjPdf->setX(20);
        $lobjPdf->SetFont("Arial","",12);
        $lobjPdf->MultiCell(175,7,utf8_decode("        Aunado a esto percibe por beneficio de Ticket de Alimentación la cantidad de Tres Mil Trecientos Setenta y Cinco con 50/100 céntimos ( Bs. 3.375,50)"));  
    ...
    $lobjPdf->setX(20);
    $lobjPdf->Cell(175,7,utf8_decode("Abg. Daira Jellynee Martinez Castillo "),0,1,"C");
    $lobjPdf->setX(20);
    $lobjPdf->Cell(175,7,utf8_decode("Gerente de Recursos Humanos"),0,1,"C");
    $lobjPdf->setX(20);
    $lobjPdf->Cell(175,7,utf8_decode("Segun Punto de Cuenta Nro 089-2015 de fecha 04/05/2015"),0,1,"C");
    $lobjPdf->setX(20);
    ...
    if ($cesta){
        ...
        $lobjPdf->setX(20);
        $lobjPdf->SetFont("Arial","",12);
        $lobjPdf->MultiCell(175,7,utf8_decode("        Aunado a esto percibe por beneficio de Ticket de Alimentación la cantidad de Tres Mil Trecientos Setenta y Cinco con 50/100 céntimos ( Bs. 3.375,500)"));  
        $lobjPdf->Cell(0,2,utf8_decode(""),0,1,"C");
        $lobjPdf->Ln();
        $lobjPdf->setX(20);
        $lobjPdf->MultiCell(175,7,utf8_decode(" Constancia que se expide en Píritu, a petición de la parte interesada a los ".$ls_dia." días de mes de ".$ls_mes." del año ".$ls_ano));   
